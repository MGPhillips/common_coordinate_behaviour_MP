...
scorer = 'DeepCut' + "_resnet" + str(resnet) + "_" + Task + str(date) + 'shuffle' + str(shuffle) + '_' + str(
    trainingsiterations)
...
video = 'E:\Dropbox (UCL - SWC)\\big_Arena\experiments\dwm\data\\basic\\190404_dwm_light_us_619_2\\190404_dwm_light_us_619_2a\cam1_FEC.avi'